...
export class Flows {
     ...
     */
    async executeRepeat(flowName, data, unsafe, i, meta = { activated: [], requestId: '' }) {
        ...
        try {
            ...
            this.getHook(SupportedHooks.exception).forEach(fn => fn({ flowName, i, actionFn: this.getAction(flowName, i), input: actionData, error: error.message || error }));
            throw error;
        }
        /** post_action hook */
